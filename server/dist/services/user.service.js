...
var post = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        try {
            ...
            newUser.save(function () { return res.status(200).json({ Message: 'User created correctly' }); });
        }
        catch (err) {
            console.log(err);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, User_model_1.default.findByIdAndUpdate(id, { set: newUser }, { new: true })];
            case 1:
                _a.sent();
                return [2 /*return*/, res.status(200).json({ Message: 'User updated succesfully' })];
            case 2:
                err_2 = _a.sent();
                console.log(err_2);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, User_model_1.default.findByIdAndRemove(id)];
            case 1:
                _a.sent();
                return [2 /*return*/, res.status(200).json({ Message: 'User removed succesfully' })];
            case 2:
                err_4 = _a.sent();
                console.log(err_4);
